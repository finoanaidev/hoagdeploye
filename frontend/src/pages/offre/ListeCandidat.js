...
const ListeCandidat = ({ searchTerm }) => {
  ...
  // Utilisez searchTerm pour filtrer les candidatures
  const filteredCandidatures = candidatures.filter(candidature => candidature.name.toLowerCase().includes(searchTerm.toLowerCase()) || candidature.prenom.toLowerCase().includes(searchTerm.toLowerCase()));
